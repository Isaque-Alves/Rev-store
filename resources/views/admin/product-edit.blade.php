                    ...
                    <div class="flex flex-wrap">
                        <div class="p-2 w-1/2">
                            <div class="relative">
                                ...
                                <input type="text" value="{{ old('name', $product->name) }}" id="name" name="name" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                            </div>
                            @error('name')
                        ...
                        <div class="p-2 w-1/2">
                            <div class="relative">
                                ...
                                <input type="text" value="{{ old('price', $product->price) }}" id="price" name="price"
                        ...
                        <div class="p-2 w-1/2">
                            <div class="relative">
                                ...
                                <input type="text" id="stock" value="{{ $product->stock }}" name="stock"
                                    class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                            </div>
                            @error('stock')
                                <p class="text-red-500 text-xs italic">{{ $message }}</p>
