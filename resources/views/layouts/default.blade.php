    ...
    <header class="text-gray-600">
        <div class="container mx-auto flex justify-between items-center p-5 items-center">
            <a href="{{ route("home") }}" class="flex title-font font-medium items-center text-gray-900">
                ...
                <span class="ml-3 text-xl">Rev Store</span>
            </a>
            <div class="flex items-center">
                <form action="/" method="get">
                    <div class="flex md:flex-nowrap flex-wrap justify-center items-center md:justify-start">
                        <div class="relative sm:w-64 w-40 sm:mr-4 mr-2">
                            <input placeholder="Search" type="text" id="search" name="search" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:ring-2 focus:bg-transparent focus:ring-indigo-200 focus:border-indigo-500 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                        </div>

                        <button type="submit" class="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">
